...
В каждой папке есть README.md с кратким описанием упражнений, которые выполнялись. В тексте описания также есть пометка для какой задачи выполнялось упражнение.
